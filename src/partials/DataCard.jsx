...
const DataQuad = ({ title, onInputChange }) => {
    ...
    return (
        <div className=''>
            ...
            <h3 className='w-full text-left font-semibold text-2xl mb-2'>Treatment</h3>
            ...
            <div className='w-full flex justify-center gap-4'>
                <div className='flex flex-col'>
                    ...
                    <input
                        ...
                        min={0}  
                        placeholder="Total" 
                        onChange={(e) => handleChange(setTreatment, 'total', e.target.value)} />
                </div>
                <div className='flex flex-col'>
                  ...
                  min={0}  
                  placeholder="Events" 
                  onChange={(e) => handleChange(setTreatment, 'events', e.target.value)} />
                </div>
            ...
            {/* Control */}
            <div className='border p-4 col-span-1 rounded bg-slate-600 text-white'>
            <h3 className='w-full text-left font-semibold text-2xl mb-2'>Control</h3>
            <div className='w-full flex justify-center gap-4'>
                <div className='flex flex-col'>
                    <label className='text-sm'>Total</label>
                    <input
                        ...
                        min={0}  
                        placeholder="Total" 
                        onChange={(e) => handleChange(setControl, 'total', e.target.value)} />
                </div>
                <div className='flex flex-col'>
                    <label className='text-sm'>Events</label>
                    <input
                  ...
                  min={0}  
                  placeholder="Events" 
                  onChange={(e) => handleChange(setControl, 'events', e.target.value)} />
                </div>
            ...
            <div className='w- mx-auto mt-5'>
                ...
                {control.total - control.events > 0 && Array.from({ length: control.total - control.events }).map((_, i) => (
                    <div key={i} className='w-2 h-2 rounded-full bg-gray-300'></div>
                ))}
            </div>
            </div>
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 p-4'>
            ...
            <div className='col-span-1 mt-10'>
                {selectedQuads.seriousSideEffects && <DataQuad title="Serious Side Effects"/>}
            </div>
            <div className='col-span-1 mt-10' >
