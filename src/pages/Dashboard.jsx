        ...
        <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden w-full">
          ...
          <main>
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
              ...
              <a
                href="https://pubmed.ncbi.nlm.nih.gov/36010916/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="font-md text-slate-800 mt-2 p-4 bg-blue-100 rounded flex flex-row justify-between">
                  <div>
                    <div className="font-semibold flex flex-row lg:text-lg text-md">
                      {" "}
                      A Causal Framework for Making Individualized Treatment
                      Decisions in Oncology
                    </div>
                    <div className="text-xs font-md italic">
                      Published: 2022 Aug 14;14(16):3923. doi:
                      10.3390/cancers14163923. Authors: Pavlos Msaouel, Juhee
                      Lee, Jose A Karam, Peter F Thall
                    </div>
                  </div>
